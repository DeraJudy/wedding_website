      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto font-modern">
            Your presence is our greatest gift! But if you'd like to bless our
            new journey, here's how you can.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-elegant p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center bg-secondary/50 rounded-xl p-4">
                <div>
                  <p className="font-modern text-sm text-gray-500 mb-1">Bank</p>
                  <p className="font-semibold text-gray-700">Opay</p>
                </div>
        ...
        >
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 font-modern mb-6 max-w-xs mx-auto">
              If you’d like to bless us as we begin this beautiful journey
              together, we would be truly grateful.
            </p>

            {/* Button */}
            <button
              onClick={() => window.open('https://paystack.shop/pay/wnqzq-7y-u', '_blank')}
